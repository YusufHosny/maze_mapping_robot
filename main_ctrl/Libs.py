...
class Gyroscope:
    ...
    def update(self, reading: Reading = Reading(0,0,0,0,0,0)):
        try:
            ...
            self._angle += (tcur - self.tprev) * gyro_z
            ...
            # read values from 6dof module
            # gyro_xout = reading.gyro_x
            # gyro_yout = reading.gyro_y
            gyro_zout = reading.gyro_z
            #
            # accel_xout = reading.accel_x
            # accel_yout = reading.accel_y
            # accel_zout = reading.accel_z
